...
export default async function MovieDetailsPage(props: { params: Promise<{ id: string }> }) {
  ...
  const movie = await getMovieDetails(id, { append_to_response: 'credits,recommendations' }).catch(() => null);
    ...
    return (
      <main className="min-h-screen bg-cinema-black pt-20 px-6">
        <div className="container mx-auto text-center py-16">
          ...
          <p className="text-cinema-white-dim mb-8">The movie you&apos;re looking for doesn&apos;t exist or has been removed.</p>
        ...
        <div className="relative z-10 flex h-full items-center">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl space-y-6">
              ...
              {/* Rating and Info */}
              <div className="flex items-center space-x-6 text-cinema-white">
